...
const double STANDART_BUTTON_ROUNDNESS = 10;
const double STANDART_ICON_SIZE = 20;
const double STANDART_ICON_SIZE_BIG = 30;

const double FLOW_SLIDER_HIGHT = 110;
const double FLOW_SLIDER_INDICATOR_HIGHT = 10;
const double FLOW_SLIDER_SINGLE_IMAGE_WIDTH = 100;

const double STANDART_HORIZONTAL_PADDING = 20;
