import 'package:acronyc_app/pages/single_skill_screens/single_transition_page/single_transition_body.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          titleSpacing: 0,
          centerTitle: true,
          actions: [AppBarActionsTransition(transition: transition)],
          title: Row(
