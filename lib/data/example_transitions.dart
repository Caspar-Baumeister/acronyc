...
TransitionModel transition0 = TransitionModel(
  name: "SIDDHI SIDESTAR",
  id: "siddhi_sidestar",
  steps: [
    StepModel(
  ...
  startAsanaId: "bird",
  endAsanaId: "revered_foot_to_hand",
);

TransitionModel transition1 = TransitionModel(
  name: "SIDDHI SIDESTAR",
  id: "siddhi_sidestar",
  steps: [
    StepModel(
  ...
  difficulty: Difficulty.medium,
  startAsanaId: "bird",
  endAsanaId: "reversed_shoulder_stand",
);
