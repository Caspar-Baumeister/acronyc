...
AsanaModel exampleAsana0 = AsanaModel(
    id: "bird",
    name: "Bird",
    img: "assets/images/asanas_base/bird.JPG",
    steps: [
      StepModel(
...
AsanaModel exampleAsana1 = AsanaModel(
    ...
    img: "assets/images/asanas/reversed_foot_to_hand.jpg",
    steps: [
      StepModel(
...
AsanaModel exampleAsana2 = AsanaModel(
    ...
    img: "assets/images/asanas/reversed_shoulder_stand.jpg",
    steps: [
      StepModel(
...
AsanaModel exampleAsana3 = AsanaModel(
  ...
  img: "assets/images/asanas_base/lowf2h.jpg",
  steps: [
    StepModel(
      image: "assets/images/asanas/reversed_shoulder_stand_0.jpg",
      description:
...
AsanaModel exampleAsana4 = AsanaModel(
    ...
    img: "assets/images/asanas_base/ext_rev_h_2_h.jpg",
    steps: [
      StepModel(
        image: "assets/images/asanas/reversed_shoulder_stand_0.jpg",
        description:
...
AsanaModel exampleAsana5 = AsanaModel(
    ...
    img: "assets/images/asanas_base/rev_h_2_f.jpg",
    steps: [
      StepModel(
        image: "assets/images/asanas/reversed_shoulder_stand_0.jpg",
        description:
...
AsanaModel exampleAsana6 = AsanaModel(
    ...
    img: "assets/images/asanas_base/ext_h_2_h.jpg",
    steps: [
      StepModel(
        image: "assets/images/asanas/reversed_shoulder_stand_0.jpg",
        description:
